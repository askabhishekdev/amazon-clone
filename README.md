...
- **Navigation Bar**:
  ...
  - Sign-in prompt, Returns & Orders section, and Cart icon
- **Sub-Navigation Panel**:
  - Hamburger menu ("All") with quick links (Today's Deals, Customer Service, Registry, Gift Cards, Sell)
- **Hero Banner Section**:
...
### Prerequisites
No external dependencies or build tools are required! You only need a modern web browser.

### How to Run Locally

1. **Clone the repository**:
   ```bash
   git clone https://github.com/askabhishekdev/amazon-clone.git
   ```
...
3. **Open `index.html`** in your browser:
   - Double-click `index.html` directly, or open it with Live Server in VS Code.
...
- **CSS3**: Flexbox layout, background positioning, hover animations
- **FontAwesome 7**: Vector icons for search, location, cart, and menus

---

## 👨‍💻 Author

Created by [askabhishekdev](https://github.com/askabhishekdev)
